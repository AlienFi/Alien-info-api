...
export interface Query {
  ...
  readonly pancakeDayDatas: ReadonlyArray<BscswapDayData>;
  readonly pancakeFactories: ReadonlyArray<UniswapFactory>;
  readonly pancakeFactory?: Maybe<UniswapFactory>;
...
export interface QueryPancakeDayDataArgs {
  block?: Maybe<Block_Height>;
  id: Scalars['ID'];
}


export interface QueryPancakeDayDatasArgs {
  block?: Maybe<Block_Height>;
  first?: Maybe<Scalars['Int']>;
...
export interface QueryPancakeFactoriesArgs {
  block?: Maybe<Block_Height>;
  first?: Maybe<Scalars['Int']>;
...
export interface QueryPancakeFactoryArgs {
  block?: Maybe<Block_Height>;
  id: Scalars['ID'];
}
...
export interface SubscriptionPancakeDayDataArgs {
  block?: Maybe<Block_Height>;
  id: Scalars['ID'];
}


export interface SubscriptionPancakeDayDatasArgs {
  block?: Maybe<Block_Height>;
  first?: Maybe<Scalars['Int']>;
  orderBy?: Maybe<BscswapDayData_OrderBy>;
  orderDirection?: Maybe<OrderDirection>;
...
export interface SubscriptionPancakeFactoriesArgs {
  block?: Maybe<Block_Height>;
  first?: Maybe<Scalars['Int']>;
  orderBy?: Maybe<UniswapFactory_OrderBy>;
  orderDirection?: Maybe<OrderDirection>;
...
export interface SubscriptionPancakeFactoryArgs {
  block?: Maybe<Block_Height>;
  id: Scalars['ID'];
}
...
export interface UniswapFactory_Filter {
  ...
  readonly totalPairs_in?: Maybe<ReadonlyArray<Scalars['Int']>>;
  ...
  readonly totalPairs_not_in?: Maybe<ReadonlyArray<Scalars['Int']>>;
...
export type TotalLiquidityQuery = (
  { readonly __typename?: 'Query' }
  & { readonly pancakeFactories: ReadonlyArray<(
    { readonly __typename?: 'UniswapFactory' }
    & Pick<UniswapFactory, 'totalLiquidityUSD' | 'totalVolumeUSD' | 'totalPairs'>
    & { totalVolumeETH: UniswapFactory['totalVolumeETH'], totalLiquidityETH: UniswapFactory['totalLiquidityETH'] }
  )> }
);
